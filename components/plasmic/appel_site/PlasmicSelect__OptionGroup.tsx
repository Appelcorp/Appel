...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: QPt5Pnh3kS8/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: NNJmEAQECZJ/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__taI7)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__ypOdz)}
              />
            </React.Fragment>
          ),
          value: args.children
