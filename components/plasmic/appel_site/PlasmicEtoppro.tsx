...
import sty from "./PlasmicEtoppro.module.css"; // plasmic-import: PDT1ClOTrWQ/css
...
export type PlasmicEtoppro__VariantMembers = {};
export type PlasmicEtoppro__VariantsArgs = {};
type VariantPropType = keyof PlasmicEtoppro__VariantsArgs;
export const PlasmicEtoppro__VariantProps = new Array<VariantPropType>();

export type PlasmicEtoppro__ArgsType = {};
type ArgPropType = keyof PlasmicEtoppro__ArgsType;
export const PlasmicEtoppro__ArgProps = new Array<ArgPropType>();

export type PlasmicEtoppro__OverridesType = {
  single?: p.Flex<"div">;
  columns?: p.Flex<"div">;
  h1?: p.Flex<"h1">;
...
export interface DefaultEtopproProps {}
...
function PlasmicEtoppro__RenderFunc(props: {
  variants: PlasmicEtoppro__VariantsArgs;
  args: PlasmicEtoppro__ArgsType;
  overrides: PlasmicEtoppro__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicEtoppro.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicEtoppro.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
          ...
          {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
            ...
            >
              ...
              >
                ...
                {false ? (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__w74Cr)}
                  >
                    <button
                      className={classNames(
                        projectcss.all,
          ...
          {true ? (
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__rVm9B)}>
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.column__uCaWc)}
                  >
                    <p.PlasmicImg
                      alt={""}
                      ...
                      src={{
                        src: "/plasmic/appel_site/images/etopPropng.png",
                        fullWidth: 4234,
                        fullHeight: 2480,
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicEtoppro__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicEtoppro__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicEtoppro__ArgProps,
          internalVariantPropNames: PlasmicEtoppro__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicEtoppro__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "single") {
    func.displayName = "PlasmicEtoppro";
  } else {
    func.displayName = `PlasmicEtoppro.${nodeName}`;
  }
  return func;
}

export const PlasmicEtoppro = Object.assign(
  // Top-level PlasmicEtoppro renders the root element
  makeNodeComponent("single"),
  {
    ...
    // Metadata about props expected for PlasmicEtoppro
    internalVariantProps: PlasmicEtoppro__VariantProps,
    internalArgProps: PlasmicEtoppro__ArgProps,
