...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: aJ02Eq-P9eMq/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__kQdpH)}>
        ...
        <div className={classNames(projectcss.all, sty.freeBox__wE9Eo)}>
          ...
          >
            ...
            <div className={classNames(projectcss.all, sty.freeBox__gx18J)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
