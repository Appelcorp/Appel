...
import sty from "./PlasmicSelect2.module.css"; // plasmic-import: dU451UGPmaB/css
...
function useBehavior<P extends pp.BaseSelectProps>(
  ...
  return pp.useSelect(
    ...
    props,
    {
      ...
      OptionComponent: Select2__Option,
      OptionGroupComponent: Select2__OptionGroup
    },
    ref
  );
}
