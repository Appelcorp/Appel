...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: FUGagdHJdaBb/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__wzub3)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__pa3U9)}
              role={"img"}
            />
          ),
